// OmniCraft <-> Daytona egress relay.
//
...
// upgrades alike) to the real OmniCraft server, so the in-sandbox host's
...
export default {
  async fetch(request, env) {
    ...
    // X-OmniCraft-Host-Token and the WebSocket Upgrade), and body.
