"""OmniCraft: A declarative agent authoring and runtime framework."""
...
# subprocesses spawned via ``-m omnicraft`` in e2e tests — picks up
...
# Mirror legacy ``OMNIAGENTS_*`` env vars onto their new ``OMNICRAFT_*`` names
...
from omnicraft._env_compat import mirror_legacy_env as _mirror_legacy_env  # noqa: E402

_mirror_legacy_env()

from omnicraft.inner.datamodel import (  # noqa: E402 — must follow md5 patch
    AgentDef,
    Connection,
    Credentials,
    History,
...
from omnicraft.inner.executor import (  # noqa: E402 — must follow md5 patch
    Executor,
    ExecutorConfig,
    ExecutorError,
    ExecutorEvent,
...
from omnicraft.inner.policies import (  # noqa: E402 — must follow md5 patch
    FunctionPolicy,
    Policy,
    PolicyAction,
    PolicyResult,
...
from omnicraft.inner.tools import (  # noqa: E402 — must follow md5 patch
    AgentTool,
...
try:
    from omnicraft.inner.databricks_executor import DatabricksExecutor
...
try:
    from omnicraft.inner.open_responses_sdk import OpenResponsesExecutor
except ImportError:
    OpenResponsesExecutor = None  # type: ignore[misc,assignment]
try:
    from omnicraft.inner.openai_agents_sdk_executor import OpenAIAgentsSDKExecutor
except ImportError:
...
from omnicraft.inner.loader import load_agent_def  # noqa: E402 — must follow md5 patch
from omnicraft.inner.tracing import (  # noqa: E402 — must follow md5 patch
    disable_tracing,
    enable_tracing,
    is_tracing_enabled,
)
