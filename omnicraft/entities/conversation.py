...
# omnicraft/inner/claude_native_executor.py and
# omnicraft/inner/codex_native_executor.py.
...
class Conversation:
    ...
    :param host_id: Host that launched (or should launch) the
        ...
        sessions started via ``omnicraft run`` (the CLI
    ...
    :param terminal_launch_args: Pass-through CLI args for a native
        ...
        harness binary; the command and all bridge / OmniCraft / auth wiring
