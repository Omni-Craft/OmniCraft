...
Core OmniCraft contributes the built-in harnesses directly. Optional community
packages contribute additional harnesses through the
``omnicraft.community.harness`` entry point group.
"""
...
COMMUNITY_ENTRY_POINT_GROUP = "omnicraft.community.harness"
COMMUNITY_MODULE_PREFIX = "omnicraft.community.harness."
...
_BUILTIN_CAPABILITIES: dict[str, HarnessCapabilities] = {
    ...
    # (omnicraft/inner/open_responses_sdk.py) is concrete: interrupt_session()
...
_BUILTIN_CONTRIBUTION = HarnessContribution(
    ...
    harness_modules={
        "acp": "omnicraft.inner.acp_harness",
...
def harness_catalog() -> list[dict[str, Any]]:
    ...
    try:
        from omnicraft.onboarding.acp_auth import acp_agents
