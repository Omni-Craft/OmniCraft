...
:mod:`omnicraft.runtime.harnesses._runner` invokes after the parent resolves
``"antigravity"`` via :data:`omnicraft.runtime.harnesses._HARNESS_MODULES`. It
wraps a :class:`~omnicraft.inner.antigravity_executor.AntigravityExecutor` in an
...
from omnicraft.inner.antigravity_executor import AntigravityExecutor
