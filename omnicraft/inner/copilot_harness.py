...
Wraps a :class:`omnicraft.inner.copilot_executor.CopilotExecutor`, which drives
...
from omnicraft.inner.copilot_executor import CopilotExecutor
...
def _resolve_os_env() -> OSEnvSpec:
    ...
    Decodes the JSON-encoded dict OmniCraft serialized via
