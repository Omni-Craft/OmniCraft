...
_DEFAULT_CACHE_DIR = os.path.expanduser("~/.cache/omnicraft-egress")
...
def _generate_ca(cert_path: Path, key_path: Path) -> None:
    ...
    subject = issuer = x509.Name(
        [
            x509.NameAttribute(NameOID.COMMON_NAME, "OmniCraft Egress MITM CA"),
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "omnicraft"),
        ]
    )
