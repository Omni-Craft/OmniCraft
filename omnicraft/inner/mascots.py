"""Static terminal mascot art for OmniCraft startup banners."""
...
# ``omnicraft.cli``. Otto's starfish magenta-pink — the OmniCraft brand accent.
MASCOT_ART_COLOR = "#0fb5bd"
...
def random_mascot_color() -> str:
    ...
    :returns: Hex color string for the OmniCraft accent,
        e.g. ``"#0fb5bd"``.
    """
...
def random_mascot_lines() -> list[str]:
    ...
    mascot API, but the TUI now uses the single static OmniCraft mascot.
