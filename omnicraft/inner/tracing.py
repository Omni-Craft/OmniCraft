"""OpenTelemetry tracing integration for OmniCraft.
...
from omnicraft.runtime.telemetry import (
    parse_provider_name,
...
def enable_tracing() -> None:
    """Enable OTel tracing globally for all OmniCraft sessions."""
...
def _tracer() -> Any:
    ...
    return trace.get_tracer("omnicraft")
...
class TracingContext:
    ...
    def __init__(self, session_id: str | None = None) -> None:
        ...
        # OmniCraft session (conversation) id, stamped as ``session.id`` on
    ...
    def start_agent_span(
        ...
        if parent is None:
            ...
            from omnicraft.runtime.telemetry import SENTINEL_PARENT_SPAN_ID
