...
from omnicraft.llms.adapters._content import parse_data_uri
from omnicraft.llms.adapters.base import BaseAdapter
from omnicraft.reasoning_effort import ANTHROPIC_EFFORTS, validate_effort_or_llm_error
...
def _build_headers(
    ...
    :raises OmniCraftError: If no API key is provided.
    """
