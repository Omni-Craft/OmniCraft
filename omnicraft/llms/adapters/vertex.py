...
class VertexAdapter(GeminiAdapter):
    ...
    def _get_base_url(self) -> str:
        ...
        :raises OmniCraftError: Always — Vertex requires connection_params
    ...
    async def chat_completions(
        ...
        *,
        ...
        :returns: Chat Completions response dict or async chunk
            iterator.
        :raises OmniCraftError: If ``connection_params`` is missing
...
def _resolve_vertex_params(
    ...
    :raises OmniCraftError: If params are missing or incomplete.
    """
