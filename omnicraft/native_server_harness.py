...
:class:`~omnicraft.native_server_transport.NativeServerTransport`. It is
...
from omnicraft.native_server_transport import NativePrompt, NativeServerTransport
...
class NativeServerHarness(Executor):
    ...
    async def run_turn(
        ...
        :param messages: Conversation history; the latest user message is
            delivered.
        :param tools: OmniCraft tool schemas (ignored — native owns tools).
