...
:func:`omnicraft.onboarding.ambient.codex_auth_has_credential` and
:func:`omnicraft.onboarding.ambient.claude_auth_has_credential`, it cannot detect
...
:func:`omnicraft.onboarding.harness_install.harness_cli_logged_in` asks the CLI
...
def gemini_auth_has_credential(creds_path: Path | None = None) -> bool:
    ...
    :func:`omnicraft.onboarding.harness_install.harness_cli_logged_in`.
