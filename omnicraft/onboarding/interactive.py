...
selection primitives used by ``omnicraft setup --no-internal-beta`` (and any
future configure noun). The look reproduces
:mod:`omnicraft.repl._theme_picker`:
...
from :mod:`omnicraft.repl._theme_picker` rather than imported: that
