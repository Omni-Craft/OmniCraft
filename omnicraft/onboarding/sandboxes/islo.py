...
Islo HTTP API directly through ``httpx`` (already a base OmniCraft
...
- **Prebaked host image.** Like Modal and Daytona, sandboxes boot from
  the official OmniCraft host image unless overridden. That keeps
...
HOST_IMAGE_ENV_VAR: str = "OMNICRAFT_ISLO_HOST_IMAGE"
"""Environment variable overriding :data:`DEFAULT_HOST_IMAGE` for Islo
sandboxes."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "OMNICRAFT_ISLO_SANDBOX_ENV"
