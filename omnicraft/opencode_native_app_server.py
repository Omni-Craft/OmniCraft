...
Mirrors :mod:`omnicraft.codex_native_app_server` but for OpenCode's HTTP +
...
is runner-internal — the web UI attaches to OmniCraft terminal resources,
...
from omnicraft.opencode_native_client import (
...
# try an as-yet-unvalidated 1.18+/v2 release). Mirrors OMNICRAFT_NO_UPDATE_CHECK.
_SKIP_VERSION_CHECK_ENV = "OMNICRAFT_OPENCODE_SKIP_VERSION_CHECK"
...
def filtered_server_env(
    *,
    ...
    :param extra_env: Additional provider env (e.g. from OmniCraft setup).
