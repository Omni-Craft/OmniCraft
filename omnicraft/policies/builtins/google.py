...
:mod:`omnicraft.policies.schema`): ``tool_call`` events carry
...
YAML usage::
    ...
    policies:
      gdrive_guard:
        type: function
        function:
          path: omnicraft.policies.builtins.google.gdrive_policy
          arguments: {read_all: false, read_files: ["1AbC..."], allow_create: true}
      gmail_guard:
        type: function
        function:
          path: omnicraft.policies.builtins.google.gmail_policy
...
from omnicraft.policies.schema import PolicyEvent, PolicyResponse, StateUpdateEntry
