...
YAML usage::
    ...
    policies:
      no_dir_switch:
        type: function
        function:
          path: omnicraft.policies.builtins.working_dir.block_working_dir_changes
          arguments:
...
from omnicraft.policies.builtins._shell import (
    MAX_SHELL_NESTING,
...
# Includes both the OmniCraft built-in OS shell and Claude Code / Codex
...
def block_working_dir_changes(
    *,
    ...
    :param shell_tools: Names of the shell tools whose ``command`` argument is
        ...
        (OmniCraft built-in + Claude/Codex native). Commands run through
