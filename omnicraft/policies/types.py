...
:mod:`omnicraft.spec.types`; runtime evaluation types live
here.
...
:mod:`omnicraft.policies` package entry point).
"""
...
from omnicraft.spec.types import Phase, PolicyAction, StateUpdate
...
# (``omnicraft.runner.app`` and ``omnicraft.runtime.harnesses._scaffold``)
...
class EvaluationContext:
    ...
    :param llm_client: An :class:`~omnicraft.policies.types.PolicyLLMClient`
...
class PolicyLLMClient:
    ...
    Wraps an :class:`~omnicraft.llms.client.Client` with the
    ...
    :param _client: The underlying multi-provider LLM client.
        An :class:`~omnicraft.llms.client.Client` instance
    ...
    _client: Any  # omnicraft.llms.client.Client — Any to avoid import cycle
    _model: str
    ...
    async def create(
        ...
        **kwargs: Any,
        ...
        :returns: A :class:`~omnicraft.llms.types.Response`.
        """
