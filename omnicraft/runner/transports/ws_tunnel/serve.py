...
# (``omnicraft.chat._wait_for_remote_runner``, currently 60 s).
        ...
        try:
            ...
            if redirect_url is not None:
                ...
                raise RuntimeError(
                    ...
                    "run `omnicraft setup` to configure credentials"
                ) from exc
...
async def _serve_tunnel_once(
    ...
    *,
    ...
    :param server_url: HTTP(S) server base URL the tunnel belongs to,
        e.g. ``"https://example.databricks.com/api/2.0/omnicraft"``. Used
