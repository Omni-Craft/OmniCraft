...
if TYPE_CHECKING:
    ...
    from omnicraft.server.smart_routing import RoutingClient
    from omnicraft.spec.types import LLMConfig, PolicySpec
...
class RuntimeCaps:
    ...
    :param policy_llm_connection_factory: Optional callable invoked
        ...
        :class:`~omnicraft.policies.types.PolicyLLMClient`. When
    ...
    # Registered by the host application (e.g. omnicrafts_app.py) to
