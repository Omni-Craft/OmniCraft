...
from omnicraft.llms.context_window import ModelPricing, compute_llm_cost
...
class PolicyEngine:
    ...
    :param llm_client: A shared
        :class:`~omnicraft.policies.types.PolicyLLMClient`
    ...
    def apply_label_writes(self, set_labels: dict[str, str]) -> None:
        ...
        Keys with no ``LabelDef`` are set freely (omnicraft
    ...
    def reset_turn(self) -> None:
        ...
        Mirrors the omnicraft-native semantics in
