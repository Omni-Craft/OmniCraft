...
:mod:`omnicraft.inner.seatbelt_sandbox` calls
...
:mod:`omnicraft.sandbox.bwrap`).

Like ``linux_bwrap`` on Linux, the Seatbelt backend is the macOS
platform default (selected by :func:`omnicraft.inner.sandbox._default_sandbox_for_platform`
...
from omnicraft.inner.seatbelt_sandbox import SeatbeltSandboxBackend
