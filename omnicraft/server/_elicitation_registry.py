...
from omnicraft.server.schemas import ElicitationResult
...
class _PreResolvedHarnessElicitation:
    ...
    :param session_id: OmniCraft session id that issued the resolution, e.g.
        ``"conv_abc123"``.
...
# race between a native client answering instantly and the OmniCraft hook
...
def reset_for_tests() -> None:
    ...
    :func:`omnicraft.runtime.pending_elicitations.reset_for_tests`.
