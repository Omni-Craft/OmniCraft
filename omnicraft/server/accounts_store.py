...
Sibling to :class:`omnicraft.stores.permission_store.PermissionStore`
...
from omnicraft.db.enum_codecs import decode_account_token_kind, encode_account_token_kind
from omnicraft.db.utils import get_or_create_engine, make_managed_session_maker
from omnicraft.entities import Account, AccountToken
from omnicraft.server.auth import RESERVED_USER_LOCAL, RESERVED_USER_PUBLIC
...
class SqlAlchemyAccountStore:
    ...
    :param storage_location: SQLAlchemy database URI, e.g.
        ``"sqlite:///omnicraft.db"``. Shares the connection pool
    ...
    def create_user_with_password(
        ...
        *,
        ...
        :param password_hash: Pre-hashed password (see
            :mod:`omnicraft.server.passwords`). Plaintext never
    ...
    def set_admin(self, user_id: str, is_admin: bool) -> None:
        ...
        (:func:`omnicraft.server.admin_list.promote_if_listed`), which
    ...
    def get_password_hash(self, user_id: str) -> str | None:
        ...
        :func:`omnicraft.server.passwords.verify_password` — never
