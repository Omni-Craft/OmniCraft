...
:mod:`omnicraft.runtime.session_stream`, the registry is process-local
...
# subscriber registry in ``omnicraft.runtime.session_stream``.
...
def reset_for_tests() -> None:
    ...
    ``omnicraft.server._elicitation_registry.reset_for_tests`` —
