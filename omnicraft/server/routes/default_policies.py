...
from omnicraft.policies.registry import is_registered_handler, validate_factory_params
from omnicraft.runtime.policies.builder import invalidate_default_policy_specs_cache
from omnicraft.server.auth import AuthProvider
from omnicraft.server.routes._auth_helpers import get_user_id
...
async def _require_admin(
    ...
    :raises OmniCraftError: 401 if unauthenticated, 403 if
        not an admin.
    """
...
def create_default_policies_router(
    ...
    async def create_policy(
        ...
        :raises OmniCraftError: 401/403 if the user lacks admin
    ...
    async def list_policies(
        ...
        :raises OmniCraftError: 401 if unauthenticated in
            multi-user mode.
        """
    ...
    async def get_policy(
        ...
        :raises OmniCraftError: 401 if unauthenticated, or
