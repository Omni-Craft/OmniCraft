...
CLOSED_LABEL_KEY = "omnicraft.closed"
...
def labels_with_closed_status(
    ...
    New closes persist ``omnicraft.closed=true`` directly. Older
    ...
    :param title: Stored conversation title, e.g.
        ``"researcher:auth:closed:conv_abc123"``.
    :returns: A mutable labels dict with ``omnicraft.closed=true``
