...
Enables built-in tools provided by omnicraft. Each entry is either a plain
...
registration boundary (`omnicraft.cli._resolve_bundle_env_vars`), never
...
**Security note — SSRF risk:** The omnicraft server makes outbound HTTP
