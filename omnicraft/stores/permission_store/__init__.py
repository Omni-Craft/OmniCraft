...
from omnicraft.entities import Account, ResolvedAccess, SessionPermission
...
class PermissionStore(ABC):
    ...
    def set_admin(self, user_id: str, is_admin: bool) -> None:
        ...
        :mod:`omnicraft.server.admin_list`), which only ever passes
    ...
    def resolve_access(
        ...
        live in :mod:`omnicraft.server.permissions`
