...
See ``designs/OMNICRAFT_TERMINAL_BRIDGE.md`` for the design and the
:class:`TerminalInstance` documentation in
:mod:`omnicraft.inner.terminal` for the underlying tmux machinery.
"""

from omnicraft.terminals.registry import TerminalListEntry, TerminalRegistry
