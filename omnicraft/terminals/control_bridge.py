...
Alternative transport to :mod:`omnicraft.terminals.ws_bridge`. Where the PTY
...
native cost-approval popup (:mod:`omnicraft.native_cost_popup`) does not render
...
async def bridge_tmux_control_to_websocket(
    ...
    *,
    ...
    :func:`omnicraft.terminals.ws_bridge.bridge_tmux_pty_to_websocket` with the
