...
class ToolContext:
    ...
    :param workspace: Per-conversation persistent working
        ...
        (per ``designs/OMNICRAFT_TERMINAL_BRIDGE.md`` §4.6 cwd-resolution
    ...
    async def dispatch_async(
        ...
        *,
        ...
        - **Background dispatch (the common case).** The tool creates
          ...
          in ``omnicraft.runtime.workflow``). The handle is
