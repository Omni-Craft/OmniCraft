...
# paths strip this marker and expose ``omnicraft.closed=true`` instead.
...
class SysSessionSendTool(Tool):
    ...
    Sub-agent sessions are separate OmniCraft agent sessions (own
    ...
    :class:`omnicraft.runtime.workflow._AsyncToolHandle`:
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "are separate OmniCraft agent sessions (own conversation, "
...
def _spec_opts_into_harness_override(spec: Any) -> bool:
    ...
    ``omnicraft/runner/tool_dispatch.py`` (``_subagent_allowed_harnesses``) so
...
def _build_sys_session_send_schema(
    ...
    description = (
        ...
        if sub_specs
            ...
            "Child sessions are separate OmniCraft agent sessions (own "
...
class SysSessionShareTool(Tool):
    ...
    (:class:`omnicraft.spec.types.SharePolicy`), which is its sole gate:
...
class SysSessionCreateTool(Tool):
    ...
    The child is a separate OmniCraft agent session — its own
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "separate OmniCraft agent session — its own conversation, "
                    ...
                    "properties": {
                        ...
                        "config_path": {
                            ...
                            "description": (
                                ...
                                "'.omnicraft/agent-configs/helper.yaml'. "
