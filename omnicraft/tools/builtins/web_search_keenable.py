...
# so traffic from the OmniCraft provider is attributable.
_CLIENT_TITLE = "OmniCraft"


def _keenable_base_url() -> str:
    """Resolve the Keenable base URL; ``OMNICRAFT_KEENABLE_BASE_URL`` overrides for tests."""
    return os.environ.get("OMNICRAFT_KEENABLE_BASE_URL", _DEFAULT_KEENABLE_URL).rstrip("/")
