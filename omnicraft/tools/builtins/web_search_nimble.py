...
_CLIENT_SOURCE = "omnicraft"


def _nimble_url() -> str:
    """Resolve the Nimble Search URL; ``OMNICRAFT_NIMBLE_BASE_URL`` overrides for tests."""
    return os.environ.get("OMNICRAFT_NIMBLE_BASE_URL", _DEFAULT_NIMBLE_URL)
