...
def _perplexity_url() -> str:
    """Resolve the Perplexity URL; ``OMNICRAFT_PERPLEXITY_BASE_URL`` overrides for tests."""
    return os.environ.get("OMNICRAFT_PERPLEXITY_BASE_URL", _DEFAULT_PERPLEXITY_URL)
