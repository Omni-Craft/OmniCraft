...
# traffic from the OmniCraft provider is attributable.
_CLIENT_SOURCE = "omnicraft"


def _tavily_url() -> str:
    """Resolve the Tavily Search URL; ``OMNICRAFT_TAVILY_BASE_URL`` overrides for tests."""
    return os.environ.get("OMNICRAFT_TAVILY_BASE_URL", _DEFAULT_TAVILY_URL)
