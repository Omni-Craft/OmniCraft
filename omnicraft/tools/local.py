...
from omnicraft_client.tools import ToolMetadata, get_tool_metadata

from omnicraft.runner.identity import strip_runner_auth_secrets
from omnicraft.spec.types import LocalToolInfo, SandboxConfig
from omnicraft.tools._pep723 import parse_inline_metadata
from omnicraft.tools._srt import wrap_with_srt
...
class LocalPythonTool(Tool):
    ...
    # ``omnicraft.runtime.workflow._dispatch_local_python_tool_async``
    ...
    def _prepend_srt(
        ...
        *,
        ...
        shared :func:`~omnicraft.tools._srt.wrap_with_srt` helper
