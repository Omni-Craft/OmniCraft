"""omnicraft client SDK — Python client for the omnicraft server API.
...
Or consume semantic blocks via :class:`BlockStream`::
    ...
    from omnicraft_client import BlockStream, pipe, skip_intermediate_ends
...
from ._errors import OmniCraftError, ToolCallDenied
