...
contract for custom Python tools in omnicraft. The decorator:
...
TOOL_MARKER_ATTR = "_omnicraft_tool_metadata"
...
def tool(
    ...
    *,
    ...
    """
    Mark a module-level function as an omnicraft tool.
    ...
    ``omnicraft/tools/builtins/async_inbox.py``). The author-time
