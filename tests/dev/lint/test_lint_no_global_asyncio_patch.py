...
@pytest.mark.parametrize(
    "line",
    [
        'patch("omnicraft.tools.mcp.asyncio.sleep")',
        'mock.patch("omnicraft.tools.mcp.asyncio.sleep", new_callable=AsyncMock)',
        'monkeypatch.setattr("omnicraft.llms.client.asyncio.sleep", _fake)',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'patch("omnicraft.tools.mcp._sleep", new_callable=AsyncMock)',
...
def test_main_exit_codes(tmp_path: Path) -> None:
    ...
    dirty.write_text('patch("omnicraft.x.asyncio.sleep")\n')
    clean = tmp_path / "test_clean.py"
    clean.write_text('patch("omnicraft.x._sleep")\n')
