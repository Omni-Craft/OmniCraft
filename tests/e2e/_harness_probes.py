...
:data:`omnicraft.runtime.harnesses._HARNESS_MODULES`. Every
...
# so the OMNICRAFT_TEST_MODEL_* env vars can rebalance a harness's
...
HARNESS_PROBES: list[HarnessProbe] = [
    ...
    HarnessProbe(
        ...
        # OmniCraft YAML ``executor.harness`` spelling.
