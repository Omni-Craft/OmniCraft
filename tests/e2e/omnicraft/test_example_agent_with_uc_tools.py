...
``omnicraft/runner/uc_function.py`` — metadata fetch at agent-build
...
from tests.e2e.omnicraft._example_helpers import validate_agent_def_structure
...
def test_agent_with_uc_tools_structure(
    ...
    :param omnicraft_repo_root: Repo root for subprocess cwd so
