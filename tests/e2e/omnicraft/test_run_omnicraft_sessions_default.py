"""End-to-end: ``omnicraft run`` renders through sessions (mock LLM).
...
from tests.e2e.omnicraft._pexpect_harness import ensure_repl_test_theme_env, submit_prompt
...
def _spawn_repl(
    ...
    """Spawn ``omnicraft run`` under a PTY."""
    spawn_env = {
        **env,
        "TERM": "xterm-256color",
        "LINES": "40",
...
def test_repl_default_sessions_renders_assistant_text(
    ...
    """``omnicraft run`` renders assistant text through sessions.
