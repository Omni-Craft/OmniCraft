...
- OmniCraft' policy engine regresses.
...
def test_yaml_policies_blocks_canada_input(
    ...
    """
    ``omnicraft run agent_with_policies.yaml --harness <harness>
    ...
    yaml_path = (
        omnicraft_repo_root / "tests" / "resources" / "examples" / "agent_with_policies.yaml"
    )
