...
(:mod:`omnicraft.goose_native_forwarder`) tails Goose's SQLite session store and
mirrors the transcript back OUT as conversation items; web-composer messages are
injected INTO the TUI's tmux pane by
:class:`omnicraft.inner.goose_native_executor.GooseNativeExecutor`. This suite is
