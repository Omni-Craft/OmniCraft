...
(:mod:`omnicraft.kiro_native_session_forwarder`) tails Kiro's structured session
...
:class:`omnicraft.inner.kiro_native_executor.KiroNativeExecutor`. This suite is the
...
def _kiro_unavailable_reason() -> str | None:
    ...
    OmniCraft-managed credential). CI provisions no Kiro account, so any missing
