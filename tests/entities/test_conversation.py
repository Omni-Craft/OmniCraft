...
@pytest.mark.parametrize(
    ...
    [
            ...
            [
                {
                    "type": "input_text",
                    "text": (
                        "[Attached: /tmp/omnicraft/claude-native/0a1b/uploads/shot.png]"
                        "\n\nfix this layout bug"
                    ),
                }
            ],
        ...
        (
            [
                {"type": "input_text", "text": "[Attached file: /tmp/omnicraft/u/report.bin]"},
        ...
        (
            [{"type": "input_text", "text": "[Attached: /tmp/omnicraft/u/img.png]"}],
            None,
        ),
