"""Unit test: ``OmniCraftClient.query(..., model_override=...)`` threads to Session.
...
import pytest
from omnicraft_client._client import OmniCraftClient
...
async def test_client_query_threads_model_override_to_temporary_session(
    ...
    class _FakeSession:
        ...
        access fails loudly — see ``.claude/skills/omnicraft-testing``
        rule 3.
        """
    ...
    client = OmniCraftClient("http://example.invalid")
