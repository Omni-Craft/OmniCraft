...
import pytest
from omnicraft_client import NativeToolBlock, ToolExecution
from omnicraft_ui_sdk.terminal._tool_renderers import (
...
def test_formatter_uses_specialized_tool_renderer() -> None:
    ...
    from omnicraft_client._blocks import ToolGroup
    from omnicraft_ui_sdk.terminal._formatter import RichBlockFormatter
...
def test_formatter_result_block_preserves_arguments_for_edit_diff() -> None:
    ...
    from omnicraft_client._blocks import ToolResultBlock
    from omnicraft_ui_sdk.terminal._formatter import RichBlockFormatter
...
def test_formatter_native_tool_specialized() -> None:
    ...
    from omnicraft_client._blocks import NativeToolBlock
    from omnicraft_ui_sdk.terminal._formatter import RichBlockFormatter
