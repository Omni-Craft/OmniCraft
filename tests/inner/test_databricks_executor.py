...
from omnicraft.inner.databricks_executor import (  # noqa: E402
    DatabricksAuthError,
...
def test_resolve_databricks_auth_env_profile_falls_back_to_ambient_with_warning(
    ...
    with caplog.at_level(logging.WARNING, logger="omnicraft.inner.databricks_executor"):
...
def test_claude_sdk_executor_reuses_api_key_helper_between_turns(
    ...
    def _counting_resolve(
        ...
        *,
        ...
        return {
            ...
            "OMNICRAFT_CLAUDE_API_KEY_HELPER": f"helper-{call_count}",
    ...
    executor._extra_env = {
        "OMNICRAFT_CLAUDE_API_KEY_HELPER": "helper-initial",
        "ANTHROPIC_BASE_URL": "https://host/ai-gateway/anthropic",
        "CLAUDE_CODE_API_KEY_HELPER_TTL_MS": "900000",
        "CLAUDE_CODE_DISABLE_EXPERIMENTAL_BETAS": "1",
    }
    ...
    async def _trigger_refresh():
        ...
        try:
            ...
            pass
        return executor._extra_env.get("OMNICRAFT_CLAUDE_API_KEY_HELPER")
...
def test_bearer_auth_current_token_none_for_non_bearer(headers: dict[str, str]) -> None:
    ...
    raw header would feed callers a credential the OmniCraft server can't use.
    """
...
# ── host-keyed resolution (omnicraft login pointer records) ─────────
...
def test_profiles_for_host_normalizes_scheme_and_slash(
    ...
    """
    from omnicraft.inner.databricks_executor import _databrickscfg_profiles_for_host
