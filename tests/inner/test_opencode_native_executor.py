...
from omnicraft import opencode_http_transport as transport_mod
...
def test_harness_create_app_builds_fastapi() -> None:
    ...
    from omnicraft.inner.opencode_native_harness import create_app
...
def test_harness_executor_factory_builds_from_env(
    ...
    from omnicraft.inner.opencode_native_harness import _build_opencode_native_executor
    from omnicraft.opencode_native_bridge import OPENCODE_NATIVE_BRIDGE_DIR_ENV_VAR
