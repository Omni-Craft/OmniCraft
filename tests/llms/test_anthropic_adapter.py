...
from omnicraft.llms.adapters.anthropic import (
    _anthropic_to_chat,
    _chat_to_anthropic,
...
def test_build_headers_with_api_key() -> None:
    ...
    from omnicraft.llms.adapters.anthropic import _build_headers
...
def test_build_headers_raises_for_empty_api_key() -> None:
    """Empty string API key raises OmniCraftError."""
    from omnicraft.errors import OmniCraftError
    from omnicraft.llms.adapters.anthropic import _build_headers
...
def test_effort_to_budget_low() -> None:
    from omnicraft.llms.adapters.anthropic import _effort_to_budget
...
async def test_stream_to_chat_chunks_text_delta() -> None:
    ...
    from omnicraft.llms.adapters.anthropic import _stream_to_chat_chunks
