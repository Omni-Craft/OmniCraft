...
from omnicraft.llms._responses_to_chat import chat_stream_to_response_events
from omnicraft.llms.adapters.gemini import (
    GeminiAdapter,
    _chat_to_gemini,
    _convert_tools,
    _extract_usage,
...
from omnicraft.llms.errors import ContextWindowExceededError
from omnicraft.llms.types import FunctionCallOutput
from omnicraft.runtime.llm_retry import classify_llm_error
...
def test_gemini_stream_text_chunk() -> None:
    ...
    from omnicraft.llms.adapters.gemini import _gemini_stream_chunk_to_chat
...
def test_empty_chat_response_structure() -> None:
    ...
    from omnicraft.llms.adapters.gemini import _empty_chat_response
...
def test_none_content_becomes_empty_parts() -> None:
    ...
    from omnicraft.llms.adapters.gemini import _content_to_gemini_parts
...
async def test_get_headers_with_api_key() -> None:
    ...
    from omnicraft.llms.adapters.gemini import GeminiAdapter
...
async def test_get_headers_raises_without_api_key() -> None:
    """Missing API key raises OmniCraftError."""
    from omnicraft.errors import OmniCraftError
    from omnicraft.llms.adapters.gemini import GeminiAdapter

    adapter = GeminiAdapter()
    with pytest.raises(OmniCraftError, match="api_key"):
