"""Unit tests for :mod:`omnicraft.llms._usage_observer`.

Covers the observer registry contract (add/remove/exception-isolation)
and the auto-recorder that activates when ``OMNICRAFT_TOKEN_USAGE_JSON``
is set.
"""
...
async def test_client_notify_records_with_active_test(
    ...
    from omnicraft.llms.client import Client, _ResponsesNamespace
    from omnicraft.llms.types import MessageOutput, OutputText, Response, Usage
