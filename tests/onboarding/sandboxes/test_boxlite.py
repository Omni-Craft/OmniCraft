"""Tests for :mod:`omnicraft.onboarding.sandboxes.boxlite`."""
...
from omnicraft.onboarding.sandboxes import boxlite as blmod
from omnicraft.onboarding.sandboxes.base import (
    DEFAULT_HOST_IMAGE,
    SandboxCapabilityError,
)
from omnicraft.onboarding.sandboxes.boxlite import (
    HOST_IMAGE_ENV_VAR,
...
def test_prepare_local_requires_kvm_on_linux(
    ...
    monkeypatch.setattr("omnicraft.onboarding.sandboxes.boxlite.platform.system", lambda: "Linux")
...
def test_prepare_local_passes_on_macos(
    ...
    monkeypatch.setattr("omnicraft.onboarding.sandboxes.boxlite.platform.system", lambda: "Darwin")
    BoxliteSandboxLauncher().prepare()
