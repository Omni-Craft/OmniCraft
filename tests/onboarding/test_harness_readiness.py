...
def _isolate_cursor_credential(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    # an OMNICRAFT_CODEX_PATH override and probes on-disk global install dirs.
    ...
    import omnicraft._platform as platform

    monkeypatch.delenv("OMNICRAFT_CODEX_PATH", raising=False)
