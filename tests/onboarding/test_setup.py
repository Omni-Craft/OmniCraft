"""Tests for :mod:`omnicraft.onboarding.setup`.

Cover the onboarding helpers used by ``omnicraft setup``: env-var hygiene
...
from omnicraft.onboarding import setup as setup_mod
from omnicraft.onboarding.setup import (
...
def test_maybe_run_skips_when_skip_env_set(monkeypatch: pytest.MonkeyPatch) -> None:
    """``OMNICRAFT_SKIP_ONBOARD=1`` short-circuits before any side effects."""
