"""Tests for :mod:`omnicraft.onboarding.ucode_cleanup`.
...
from omnicraft.onboarding.ucode_cleanup import (
    UcodeWiringRemoval,
...
def test_remove_web_search_removes_ucode_owned_entry(
    ...
    cli_calls: list[bool] = []
    monkeypatch.setattr(
        "omnicraft.onboarding.ucode_cleanup._remove_web_search_via_claude_cli",
