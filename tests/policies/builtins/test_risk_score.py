...
(:mod:`omnicraft.policies.builtins.risk_score`) — the single configurable
...
from omnicraft.policies.builtins.risk_score import (
...
_HANDLER = "omnicraft.policies.builtins.risk_score.risk_score_policy"
