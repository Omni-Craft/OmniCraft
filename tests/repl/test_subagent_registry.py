"""
Unit tests for the REPL's sub-agent tree plumbing in ``omnicraft.repl._repl``.
...
from omnicraft.repl._repl import _apply_child_session_event, _refresh_subagent_tree
