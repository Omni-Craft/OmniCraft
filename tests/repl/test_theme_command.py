...
import pytest
from omnicraft_ui_sdk.terminal import RichBlockFormatter, TerminalHost
from omnicraft_ui_sdk.terminal._theme import DARK_THEME, LIGHT_THEME

from omnicraft.repl._repl import COMMANDS, _load_startup_theme, handle_slash_command
...
def test_startup_theme_falls_back_to_light_for_corrupt_config(
    ...
    config_path = tmp_path / ".omnicraft" / "config.yaml"
...
def test_startup_theme_shows_picker_on_first_launch(
    ...
    monkeypatch.setattr(
        "omnicraft.repl._theme_picker.startup_theme_picker",
