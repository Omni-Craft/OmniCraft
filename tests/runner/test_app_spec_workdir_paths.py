...
"omnicraft-python-callable"``) store a DOTTED IMPORT PATH in the same
...
from omnicraft.runner.app import _spec_with_workdir_paths
from omnicraft.spec.types import AgentSpec, LocalToolInfo
...
@pytest.mark.parametrize("language", ["omnicraft-python-callable", "python", None])
