...
_BROKEN_PATH = "omnicraft.nonexistent_module.broken_policy"
...
_RAISING_PATH = "omnicraft.policies.function.make_fixed_action_callable"
...
async def test_resolve_diagnostic_omits_exception_message_secrets() -> None:
    ...
    import omnicraft.runner.policy as policy_mod
