"""Tests for ``fetch_all_items`` in ``omnicraft/runtime/workflow.py``.
...
from omnicraft.entities.conversation import ConversationItem, MessageData
from omnicraft.entities.pagination import PagedList
from omnicraft.runtime.workflow import fetch_all_items
