"""
Tests for :func:`omnicraft.runtime.tool_output.cap_tool_output` — the canonical
...
from omnicraft.runtime.tool_output import MAX_TOOL_OUTPUT_BYTES, cap_tool_output
