...
async def policy_client(
    ...
    policy_store = SqlAlchemyPolicyStore(db_uri)
    monkeypatch.setattr("omnicraft.runtime._globals._policy_store", policy_store)
    ...
    from omnicraft.server.routes import session_policies as _sp_mod
    ...
    monkeypatch.setattr(
        ...
        lambda handler: (
            handler == "omnicraft.policies.function.make_fixed_action_callable"
