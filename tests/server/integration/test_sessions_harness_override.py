...
async def test_create_rejects_harness_override_for_non_omnicraft_agent(
    client: httpx.AsyncClient,
) -> None:
    """Non-omnicraft executor types reject the override instead of no-opping.
    ...
    agent = await create_test_agent(
        ...
        # A non-omnicraft executor type (claude_sdk rejects the helper's
