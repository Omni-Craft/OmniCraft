...
Covers the end-to-end contract — YAML parser (via the omnicraft
inner-stack loader, which is the entry point every YAML spec
flows through today), the spec translator, and the omnicraft
...
# ---------------------------------------------------------------
# Parser (omnicraft inner-stack loader) coverage.
# ---------------------------------------------------------------
