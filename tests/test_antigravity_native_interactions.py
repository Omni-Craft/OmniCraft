...
These exercise :func:`omnicraft.antigravity_native_interactions.bridge_interaction`
...
from omnicraft.antigravity_native_interactions import (
    _freshest_waiting,
    agy_elicitation_id,
    bridge_interaction,
)
...
def _question_step(
    *, step_index: int, status: str = "CORTEX_STEP_STATUS_WAITING"
    ...
    :func:`omnicraft.antigravity_native_steps.pending_interaction`:
