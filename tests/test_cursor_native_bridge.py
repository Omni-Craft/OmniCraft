"""Unit tests for :mod:`omnicraft.cursor_native_bridge` composer handling.
...
from omnicraft import cursor_native_bridge
...
class TestHooksConfig:
    ...
    def test_build_hooks_config_shape(self) -> None:
        ...
        assert "-I" in command
        assert "omnicraft.cursor_native_usage" in command
