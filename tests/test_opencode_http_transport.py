"""Unit tests for :class:`omnicraft.opencode_http_transport.OpenCodeHttpTransport`.
...
from omnicraft.opencode_http_transport import OpenCodeHttpTransport, build_prompt_payload
...
def _launch(**kwargs: Any) -> NativeLaunchConfig:
    return NativeLaunchConfig(omnicraft_session_id="conv_1", workspace="/w", **kwargs)
