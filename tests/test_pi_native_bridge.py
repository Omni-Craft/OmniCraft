...
def test_refresh_config_auth_headers_preserves_launch_written_headers(tmp_path: Path) -> None:
    ...
    with both the OAuth bearer and an ``X-OmniCraft-Runner-Tunnel-Token`` header
    ...
    pi_native_bridge.write_extension_files(
        ...
        auth_headers={
            ...
            "X-OmniCraft-Runner-Tunnel-Token": "tunnel-tok",
        },
    )
    ...
    assert payload["authHeaders"]["X-OmniCraft-Runner-Tunnel-Token"] == "tunnel-tok"
