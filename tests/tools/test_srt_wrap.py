"""Unit tests for :mod:`omnicraft.tools._srt`.
...
from omnicraft.tools._srt import is_srt_available, wrap_with_srt
...
def test_wrap_with_srt_passthrough_when_disabled() -> None:
    ...
    helper post-step-7 — see ``omnicraft/tools/mcp.py`` for
    the rationale.)
    """
