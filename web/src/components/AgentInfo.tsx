...
const MODEL_TOKEN_ROWS: ReadonlyArray<{ key: keyof ModelUsage; label: string }> = [
  ...
  { key: "cacheReadInputTokens", label: "Leitura de cache" },
  { key: "cacheCreationInputTokens", label: "Gravação de cache" },
            ...
            >
              ...
              {usage.totalCostUsd != null && (
                <div className="flex items-baseline justify-between gap-3 pl-2 text-xs">
                  <span className="text-muted-foreground/70">Custo</span>
                  <span className="tabular-nums text-muted-foreground">
    ...
    >
      <DialogContent className="max-h-[80vh] overflow-y-auto sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Escolha uma política para aplicar a esta sessão.</DialogDescription>
        </DialogHeader>
...
function validateMcpForm(form: McpFormState): string | null {
  ...
  if (!/^[A-Za-z0-9_-][A-Za-z0-9_.-]{0,127}$/.test(name)) {
    return "O nome pode usar letras, números, pontos, hífens e sublinhados.";
  }
  if (form.transport === "http") {
    const url = form.url.trim();
    if (!url) return "A URL é obrigatória.";
  ...
  function notifyRestart() {
    ...
    showToast(
      <span className="text-sm">
        Servidores MCP atualizados. Reinicie a sessão para aplicar as mudanças.
      </span>,
    );
  }
  ...
  return (
    ...
    >
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Gerenciar servidores MCP</DialogTitle>
          <DialogDescription>
            Adicione, edite ou remova servidores MCP para esta sessão.
          </DialogDescription>
        </DialogHeader>
        {dirty && (
          <div className="flex items-center gap-2 rounded-md border border-yellow-500/40 bg-yellow-500/10 px-3 py-2 text-sm text-yellow-700 dark:text-yellow-400">
            ...
            Reinicie a sessão para aplicar suas mudanças.
          </div>
        )}
        <div className="grid gap-4 pt-1 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          <div className="flex min-w-0 flex-col gap-1.5">
            ...
            {servers.length > 0 ? (
              ...
              <p className="py-3 text-xs text-muted-foreground">Nenhum servidor MCP</p>
            )}
            {form.originalName && (
          ...
          <div className="flex min-w-0 flex-col gap-2">
            <SectionLabel>{form.originalName ? "Editar servidor" : "Novo servidor"}</SectionLabel>
  ...
  return (
    <div className="flex flex-col gap-1.5 py-3">
      <div className="flex items-center justify-between">
        ...
        {canEdit && (
          <button
            ...
            title="Gerenciar servidores MCP"
            aria-label="Gerenciar servidores MCP"
          >
      ...
      {servers.length > 0 ? (
        ...
        <p className="text-xs text-muted-foreground">Nenhum servidor MCP</p>
      )}
      {canEdit && (
  ...
  return (
    <div className="flex flex-col gap-1.5 py-3">
      ...
      {userPolicies.length > 0 ? (
        ...
        <p className="text-xs text-muted-foreground">Nenhuma política adicionada</p>
      )}
      <AddPolicyDialog
        sessionId={sessionId}
        registry={registry}
    ...
    <div className="flex flex-col divide-y divide-border/50">
      ...
      {sessionId && owner && isSessionShared && (
        <div className="flex flex-col gap-1.5 py-3">
          ...
          >
            {owner}
            {owner === viewerId && <span className="ml-1 text-muted-foreground/60">(você)</span>}
          </span>
        </div>
      )}
      {sessionId && (
        <div className="flex flex-col gap-1.5 py-3">
          <SectionLabel>ID da sessão</SectionLabel>
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="ghost"
              size="icon-sm"
              aria-label={sessionIdCopied ? "ID da sessão copiado" : "Copiar ID da sessão"}
          ...
          <div className="flex flex-col gap-2 py-3">
            {sessionCostUsd != null && (
              <div className="flex items-baseline justify-between gap-3">
                <SectionLabel>Custo da sessão</SectionLabel>
                <span
  ...
  return (
    <Popover>
      <Tooltip>
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="icon"
              aria-label="Ferramentas e políticas do agente"
        ...
        <TooltipContent>Ferramentas e políticas do agente</TooltipContent>
      </Tooltip>
