 ...
 * (`--omnicraft-header-height`, `--omnicraft-inset-top/bottom`). Off the iOS shell
...
export function PageScroll({
  ...
  const style: CSSProperties = {
    paddingTop: `calc(${extraTop}${clearHeader ? " + var(--omnicraft-header-height)" : ""}${
      insetTop ? " + var(--omnicraft-inset-top)" : ""
    })`,
    paddingBottom: `calc(${extraBottom}${insetBottom ? " + var(--omnicraft-inset-bottom)" : ""})`,
  };
