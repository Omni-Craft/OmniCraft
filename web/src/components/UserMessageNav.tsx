        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              type="button"
              variant="outline"
              aria-label="Mensagem anterior do usuário"
            >
              <ChevronUpIcon className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent side="left">Mensagem anterior (⌘⌥↑)</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              type="button"
              variant="outline"
              aria-label="Próxima mensagem do usuário"
            >
              <ChevronDownIcon className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent side="left">Próxima mensagem (⌘⌥↓)</TooltipContent>
        </Tooltip>
      </div>
    </TooltipProvider>
  );
