      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            aria-label={goal ? "Ver meta do Codex" : "Definir meta do Codex"}
        ...
        <TooltipContent>{goal ? "Ver meta do Codex" : "Definir meta do Codex"}</TooltipContent>
      </Tooltip>
      <CodexGoalDialog
        open={open}
...
export function CodexGoalStatusPill({ goal }: { goal: CodexGoal }) {
  return (
    ...
    >
      ...
      <span>Meta {formatCodexGoalStatus(goal.status)}</span>
    </span>
  );
}
