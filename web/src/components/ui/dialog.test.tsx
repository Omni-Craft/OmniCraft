...
// origin to the keyboard-aware `--omnicraft-viewport-height` — but only inside
...
describe("DialogContent keyboard-aware sizing", () => {
  it("caps height and centering to the visible viewport inside the iOS shell", () => {
    ...
    expect(content.style.maxHeight).toContain("--omnicraft-viewport-height");
    expect(content.style.top).toContain("--omnicraft-viewport-height");
  });
