...
// against ~/.omnicraft_history). Web-side, history persists across tabs and
...
const STORAGE_PREFIX = "omnicraft:prompt-history";
 ...
 * @returns The localStorage key, e.g. ``"omnicraft:prompt-history:conv_abc123"``.
 */
