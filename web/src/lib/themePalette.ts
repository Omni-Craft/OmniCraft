...
export const PALETTES: readonly PaletteMeta[] = [
  {
    id: "omni",
    label: "OmniCraft",
    blurb: "O visual turquesa da marca.",
    light: {
      bg: "#fdf7fb",
      card: "#ffffff",
      accent: "#0fb5bd",
    ...
    dark: { bg: "#160e24", card: "#28223a", accent: "#0fb5bd", border: "#2a2440", text: "#f4f5f7" },
  },
  {
    id: "dracula",
    label: "Dracula",
    blurb: "Roxo melancólico com um toque de rosa.",
    light: {
      bg: "#f7f5fd",
      card: "#ffffff",
      accent: "#7c3aed",
  ...
  },
  {
    id: "github",
    label: "GitHub",
    blurb: "Neutros limpos com um azul de destaque.",
    light: {
      bg: "#f6f8fa",
      card: "#ffffff",
      accent: "#0969da",
  ...
  },
  {
    id: "catppuccin",
    label: "Catppuccin",
    blurb: "Pastéis suaves — Latte & Mocha.",
    light: {
      bg: "#eff1f5",
      card: "#ffffff",
      accent: "#8839ef",
  ...
  },
  {
    id: "gruvbox",
    label: "Gruvbox",
    blurb: "Tons terrosos retrô e aconchegantes.",
    light: {
      bg: "#fbf1c7",
      card: "#fffdf2",
      accent: "#d65d0e",
