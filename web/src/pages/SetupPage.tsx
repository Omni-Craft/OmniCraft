    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="space-y-1 text-center">
          <h1 className="text-2xl font-semibold tracking-tight">Crie a conta de administrador</h1>
          <p className="text-sm text-muted-foreground">
            Primeira execução — escolha o usuário e a senha para o admin deste servidor. Você pode
            convidar outras pessoas assim que entrar.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              title="Letras minúsculas, dígitos, pontos, hifens, sublinhados (ou um e-mail em minúsculas)"
            />
            <p className="text-xs text-muted-foreground">
              Letras minúsculas, dígitos, pontos, hifens, sublinhados — ou um e-mail em minúsculas.
            </p>
          </div>
