...
export function AddAgentDialog({
  ...
  async function handleAdd(): Promise<void> {
    ...
    if (!trimmed) {
      setError("Digite um nome para o agente.");
      return;
    }
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
          <div className="flex flex-col gap-2">
            <span className="text-xs font-medium text-muted-foreground">Escolha um agente</span>
            {agentList.length === 0 ? (
          ...
          {selectedAgent !== null && (
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                placeholder="Dê um nome a este agente"
