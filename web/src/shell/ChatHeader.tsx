...
import { CheckpointsButton } from "@/components/CheckpointsButton";
  ...
  return (
    ...
    >
      ...
      <div className={cn("flex items-center gap-1", !sidebarOpen && "traffic-light-clearance")}>
        ...
        {isChildSession && parentSessionId && (
          <>
            ...
            >
              <Link to={`/c/${parentSessionId}`} aria-label="Voltar à sessão pai">
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              {boundAgent?.name ? (
                <div className="flex min-w-0 flex-col leading-tight">
                  ...
                  <span className="text-xs text-muted-foreground">Sub-agente</span>
                </div>
              ) : (
                <span className="text-sm font-semibold text-foreground">Sub-agente</span>
              )}
            </div>
          </>
        )}
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Worktree checkpoints (snapshot / restore). Self-hides on sessions
            that don't run in a git worktree. */}
        {conversationId && <CheckpointsButton sessionId={conversationId} />}
        ...
        {canShare && shareDisabled && shareDisabledReason ? (
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              <span
                tabIndex={0}
                aria-label={`Compartilhar sessão desativado: ${shareDisabledReason}`}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                variant="ghost"
                size="icon"
                aria-label={rightPanelOpen ? "Recolher painel direito" : "Expandir painel direito"}
            ...
            <TooltipContent>
              {rightPanelOpen ? "Recolher painel direito" : "Expandir painel direito"}
            </TooltipContent>
          </Tooltip>
        )}
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  aria-label="Abrir menu da sessão"
                  className="text-muted-foreground hover:text-foreground md:hidden"
                >
                  <PanelRightIcon className="size-4" />
                </Button>
