  ...
  const actions = useMemo<ActionCommand[]>(
    () => [
      ...
      },
      {
        ...
        label: "Alternar barra lateral de conversas",
        icon: PanelLeftIcon,
      ...
      },
      {
        ...
        label: "Alternar barra lateral do workspace",
        icon: PanelRightIcon,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <Command shouldFilter={false} vimBindings={false} label="Paleta de comandos">
          <CommandInput
            value={query}
            onValueChange={setQuery}
            placeholder="Buscar sessões ou executar um comando"
            data-testid="command-palette-input"
          />
          <CommandList>
            <CommandEmpty>
              {isFetching && debouncedQuery ? "Buscando…" : "Nenhum resultado encontrado"}
            </CommandEmpty>
            {sessions.length > 0 && (
