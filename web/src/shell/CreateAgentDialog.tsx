        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="Um breve resumo do que este agente faz"
            />
          </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-muted-foreground">Ferramentas MCP</span>
              <Button
                type="button"
                variant="ghost"
                size="sm"
      ...
      {entry.transport === "stdio" ? (
        <>
          ...
          <Input
            ...
            placeholder="argumentos (ex.: -y @modelcontextprotocol/server-github)"
          />
          <Textarea
            data-testid="create-agent-mcp-env"
            value={entry.env}
            onChange={(e) => onChange({ env: e.target.value })}
            placeholder={"Variáveis de ambiente (CHAVE=VALOR por linha)\nex.: GITHUB_TOKEN=ghp_..."}
