      ...
      <DialogContent data-testid="resume-dir-dialog" className="flex flex-col gap-4 sm:max-w-lg">
        ...
        {sourceLoading || !hostsLoaded ? (
          <p className="text-xs text-muted-foreground" data-testid="resume-dir-loading">
            Carregando o diretório da sessão original…
          </p>
        ) : showCliFallback ? (
          <div className="flex flex-col gap-2" data-testid="resume-dir-cli-fallback">
            <p className="text-xs text-muted-foreground">
              O host da sessão original está offline, então não há onde iniciar um executor.
              Reconecte-o pelo seu terminal — depois envie sua mensagem novamente para escolher um
              diretório.
            </p>
            <CliCommandBlock
                  ...
                  {showConflictHint && (
                    ...
                    >
                      ...
                      <span>
                        ...
                        trabalhando neste diretório. Operações de escrita podem gerar conflitos.
                        Nomeie uma branch do git abaixo para trabalhar em uma cópia isolada.
                      </span>
                    </p>
                  )}
                  {showMismatchWarning && (
                    ...
                    >
                      <AlertTriangleIcon className="mt-0.5 size-3.5 shrink-0" />
                      <span>
                        Este diretório é diferente do da sessão original. Referências a arquivos
                        anteriores na transcrição podem não se aplicar — o agente precisará se
                        reorientar.
                      </span>
                    </p>
                  )}
