                    ...
                    <Link to="/inbox" onClick={onNavClick}>
                      ...
                      {inboxCount > 0 && (
                        <span
                          aria-label={
                            inboxCount === 1
                              ? "1 item aguardando na caixa de entrada"
                              : `${inboxCount} itens aguardando na caixa de entrada`
                          }
            ...
            {selectionMode ? (
              ...
              <div className="relative mt-3 flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="bottom">Selecionar sessões</TooltipContent>
                </Tooltip>
              </div>
            )}
          </div>
          ...
          <div className="md:shrink-0 md:px-3 md:pb-3 max-md:absolute max-md:bottom-3 max-md:left-3 max-md:z-10">
            ...
            >
              ...
              <Link to="/settings" aria-label="Configurações">
                ...
                <span className="max-md:hidden">Configurações</span>
              </Link>
            </Button>
          </div>
        </>
  ...
  return (
    ...
    >
      <ConversationSection
        ...
        emptyMessage={loadingFirstPage ? undefined : "Nenhuma conversa"}
        indentRows
        headerAction={<ProjectFolderActions projectName={name} onNavigate={onRowClick} />}
        footer={
          loadingFirstPage ? (
            <p className="px-2 py-1 pl-7 text-muted-foreground text-xs">Carregando…</p>
          ) : (
...
function ConversationList({
  ...
  if (conversationsQuery.isLoading) {
    return <p className="px-2 py-1 text-muted-foreground text-xs">Carregando…</p>;
  }
  ...
  const emptyMessage = searchQuery
    ? "Nenhuma conversa correspondente"
    : showShared
      ? "Nenhuma sessão compartilhada com você"
                ...
                headerAction={(() => {
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            variant="ghost"
                            size="icon-sm"
                            aria-label="Recolher para o estado anterior"
                  ...
                  return (
                    <Tooltip>
                      ...
                      <TooltipContent side="bottom">Expandir tudo</TooltipContent>
                    </Tooltip>
                  );
                })()}
              >
      ...
      >
        <DialogContent onClick={(e) => e.stopPropagation()}>
          <DialogHeader>
            ...
            <DialogDescription>
              Esta é a única sessão em{" "}
              <span className="break-all font-medium">{pendingUngroup?.project}</span>, então{" "}
              <span className="font-medium">o projeto também será removido</span>. A sessão em si é
              mantida.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
...
function UngroupDropZone() {
  ...
  return (
    ...
    >
      ...
      Solte aqui para remover do projeto
    </div>
  );
}
      ...
      {canManage ? (
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">
            Você precisa de permissões de gerenciamento para compartilhar esta sessão
          </TooltipContent>
        </Tooltip>
      )}
      {canEdit ? (
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">
            Você precisa de permissões de edição para renomear esta sessão
          </TooltipContent>
        </Tooltip>
      )}
      ...
      {canEdit && isOwner && (
        <C.Sub>
          <C.SubTrigger data-testid="move-to-project" className="whitespace-nowrap">
            ...
            {currentProject ? "Mover sessão" : "Adicionar ao projeto"}
          </C.SubTrigger>
      ...
      {canStop &&
        (isOwner ? (
          ...
          <Tooltip>
            ...
            <TooltipContent side="left">
              Somente o dono da sessão pode parar esta sessão
            </TooltipContent>
          </Tooltip>
        ))}
      {isOwner ? (
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">
            Somente o dono da sessão pode {isArchived ? "desarquivar" : "arquivar"} esta sessão
          </TooltipContent>
        </Tooltip>
      )}
      {isOwner ? (
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">
            Somente o dono da sessão pode excluir esta sessão
          </TooltipContent>
        </Tooltip>
      )}
    </>
    ...
    >
      ...
      <div className="flex w-full items-center gap-1.5">
        <span className="relative min-w-0 truncate">
          {label}
          {hasUnseenMessages && <span className="sr-only"> (não lida)</span>}
        </span>
      </div>
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              removidos. Isso não pode ser desfeito.
            </DialogDescription>
          </DialogHeader>
          {gitBranch !== null && (
            <div className="flex flex-col gap-2 rounded-md border border-destructive/40 bg-destructive/5 p-3">
              <p className="text-xs text-muted-foreground">
                Opcionalmente, limpe o worktree do git. Estas ações são{" "}
                <span className="font-semibold text-destructive">irreversíveis</span>.
              </p>
      ...
      <Dialog open={removeProjectOpen} onOpenChange={setRemoveProjectOpen}>
        <DialogContent onClick={(e) => e.stopPropagation()}>
          <DialogHeader>
            ...
            <DialogDescription>
              Esta é a única sessão em{" "}
              <span className="break-all font-medium">{currentProject}</span>, então{" "}
              <span className="font-medium">o projeto também será removido</span>. A sessão em si é
              mantida.
            </DialogDescription>
          </DialogHeader>
...
function DeletingRow({
    ...
    return (
      ...
      >
        ...
        <span
          ...
          title={`Não foi possível excluir ${label}`}
        >
          Não foi possível excluir <span className="font-medium">{label}</span>
        </span>
        ...
        <Button
          ...
          variant="ghost"
          size="icon-sm"
          aria-label="Descartar erro de exclusão"
          onClick={onDismiss}
        >
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0 text-xs">Excluindo…</span>
    </div>
  );
}
...
function ArchivingRow({ label }: { label: string }) {
  return (
    ...
    >
      ...
      <span className="shrink-0 text-xs">Arquivando…</span>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center">
      ...
      <Button
        ...
        variant="ghost"
        size="icon-sm"
        aria-label={`Nova sessão em ${projectName}`}
      ...
      <DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            variant="ghost"
            size="icon-sm"
            aria-label={`Ações do projeto para ${projectName}`}
      ...
      <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <DialogContent onClick={(e) => e.stopPropagation()}>
          <DialogHeader>
            ...
            <DialogDescription>
              Isso arquiva o projeto{" "}
              <span className="rounded bg-muted px-1 py-0.5 font-mono text-[0.95em] break-all">
                {projectName}
              </span>{" "}
              e <span className="font-medium">todas as suas sessões</span>. O histórico delas é
              mantido. Você pode encontrá-las e restaurá-las a qualquer momento em Configurações.
            </DialogDescription>
          </DialogHeader>
          {deleteProject.isError && (
            <p className="text-sm text-destructive" role="alert">
              Algumas sessões não puderam ser arquivadas (você pode não ser o dono delas); as demais
              foram arquivadas.
            </p>
          )}
          <DialogFooter className="border-t-0 bg-transparent">
  ...
  return (
    <>
      <div className="relative mt-3 flex flex-col gap-1.5">
        <div className="relative flex min-h-8 items-center gap-1.5 px-2 pr-9">
          <span className="shrink-0 whitespace-nowrap text-sm text-muted-foreground">
            {count === 0 ? "Nenhuma selecionada" : `${count} selecionada(s)`}
          </span>
          <Button
            type="button"
            variant="ghost"
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom">Sair da seleção</TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="flex items-center gap-1.5 px-2">
          ...
          >
            ...
            Excluir {ownedSelected.length > 0 ? ownedSelected.length : ""}
          </Button>
        </div>

        {(bulkArchive.isError || bulkDelete.isError) && (
          <p className="text-xs text-destructive" role="alert">
            Algumas ações falharam. Tente novamente ou descarte.
          </p>
        )}
      </div>
      ...
      <Dialog open={confirmDeleteOpen} onOpenChange={setConfirmDeleteOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Excluir {ownedSelected.length} sessão(ões)?</DialogTitle>
            <DialogDescription>
              Isso excluirá permanentemente as sessões selecionadas e todo o seu histórico. Isso não
              pode ser desfeito.
            </DialogDescription>
          </DialogHeader>
          <p className="flex items-start gap-2 rounded-md border border-warning/40 bg-warning/5 p-3 text-xs text-muted-foreground">
            ...
            Os branches não são limpos. Use a exclusão individual de sessão para lidar com branches.
          </p>
          <DialogFooter className="border-t-0 bg-transparent">
            <Button
              type="button"
            ...
            <Button
              ...
              disabled={bulkDelete.isPending}
            >
              Excluir {ownedSelected.length} sessão(ões)
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
