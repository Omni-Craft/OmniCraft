 ...
 * owned by the web layer. This fills its center with "OmniCraft — <host>" and
 ...
 *
 * When a thread is open, its title replaces the "OmniCraft" brand label
...
export function TitleBarServerPicker({
  ...
  /** Title of the currently open thread, or null/undefined when no thread
      is selected or it has no title yet (falls back to "OmniCraft"). */
      ...
      <DropdownMenu>
        ...
        >
          <span className="truncate font-medium">
            {threadTitle || "OmniCraft"} — {hostOf(info.currentOrigin)}
          </span>
