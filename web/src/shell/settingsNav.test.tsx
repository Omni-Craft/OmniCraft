...
describe("SettingsSidebarBody", () => {
  ...
  it("does NOT close the sidebar when 'Voltar ao OmniCraft' is tapped", () => {
    ...
    fireEvent.click(screen.getByRole("link", { name: /Voltar ao OmniCraft/ }));
    expect(onNavClick).not.toHaveBeenCalled();
  });

  it("'Voltar ao OmniCraft' returns to the conversation the user came from", () => {
    ...
    expect(screen.getByRole("link", { name: /Voltar ao OmniCraft/ })).toHaveAttribute(
      "href",
