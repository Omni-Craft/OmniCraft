...
export const PINNED_CONVERSATION_IDS_STORAGE_KEY = "omnicraft:pinned-conversation-ids";
...
export const COLLAPSED_SIDEBAR_SECTIONS_STORAGE_KEY = "omnicraft:collapsed-sidebar-sections";
...
export const EXPANDED_PROJECT_SECTIONS_STORAGE_KEY = "omnicraft:expanded-project-sections";
...
export const UNTITLED_CONVERSATION_LABEL = "Nova sessão";
