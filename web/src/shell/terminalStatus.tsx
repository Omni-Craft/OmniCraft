...
export const STATUS_CONFIG: Record<TerminalStatus, { label: string; className: string }> = {
  ...
  idle: { label: "Ocioso", className: "bg-muted-foreground/55" },
  connecting: { label: "Conectando", className: "bg-amber-500 animate-pulse" },
  error: { label: "Erro", className: "bg-red-500" },
  closed: { label: "Fechado", className: "bg-black dark:bg-white" },
};
